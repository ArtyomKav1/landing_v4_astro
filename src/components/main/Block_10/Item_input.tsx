      ...
      <div className={`w-full h-[56px]  rounded-[12px] relative px-[20px] z-0 overflow-hidden bg-[#B879F2]`}>
        ...
        </div>
        {
          meta.touched && !meta.error && (
            <div className="group">
              <img src="/check.png" width={20} height={20} className="absolute right-[10px] 2xl:top-[10px] top-[20px] 2xl:w-[40px] w-[20px] 2xl:h-[40px] h-[20px]" alt="" />
              <span
        ...
        <Error name={props.name}>
          {(error) => <div className="group ">
            <img src="/warning.png" width={20} height={20} className="absolute right-[10px] 2xl:top-[10px] top-[20px] 2xl:w-[40px] w-[20px] 2xl:h-[40px] h-[20px]" alt="" />
            <span
